...
function renderTable() {
    let tbody = document.querySelector("#pendingTable tbody");
    tbody.innerHTML = '';
    ...
    reportsData.forEach(r => {
        ...
        if (!r.username.toLowerCase().includes(search) &&
            !r.message.toLowerCase().includes(search)) return;
        ...
        <tr>
            ...
            <td data-label="Action">
                <button onclick="notifyReport(${r.id})">Notify</button>
            </td>
        </tr>`;
    });
}
